(() => {
  ...
  //? Bajo acoplamiento
  //* Bajo acoplamiento ya que si se quiere agregar un atributo será más facil ya que las clases no son
  //* muy dependientes entre si ya que no hay herencia sino composición 
  type Gender = 'M' | 'F';
